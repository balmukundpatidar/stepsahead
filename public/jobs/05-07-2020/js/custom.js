...
// active url base class add on body
var getUrl = window.location.pathname;
var removeSlash = getUrl.split('/');
var popUrl = removeSlash.pop('.').split('.')[0];
if (getUrl == '') {
    $('body').addClass('home');
} else {
    $('body').addClass('get-' + popUrl);
}
...
var target = $('.navigation .nav a[href="' + path + '"]');
// Add active class to target link
target.addClass('active');


// add blur on popup open
