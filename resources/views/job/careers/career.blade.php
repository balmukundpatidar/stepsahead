    ...
    <!-- Start About Us -->
        ...
        <div class="container">
            ...
            <div class="tab">
                ...
                <a href="{{route('job_search_result',['id'=>$cat->id])}}"> <button class="tablinks">{{$cat->cat_title}}</button></a>

                {{--<a href="{{route('job_search_result',['id'=>$cat->id])}}"><button class="tablinks">Office & Other Vacancies</button></a>--}}
