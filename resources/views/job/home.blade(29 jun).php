...
@section('content')
  ...
  <main>
    ...
    <!-- Support Plan -->
    <section class="sec sec-support-and-plan bg-gray">
      <div class="container">
        <div class="heading-01 wow fadeInDown">
          <h2><span>Assessment of Need</span>Support Plan</h2>
        </div>
        <div class="row">
      ...
      <div class="container">
        ...
        <div class="steps-portfolio">
          <div class="portfolio-buttons">
            ...
            <button class="portfolio-button" data-filter=".category_1">
              Living Room
            </button>
            <button class="portfolio-button" data-filter=".category_2">
              Room
            </button>
            <button class="portfolio-button" data-filter=".category_3">
              Activities
            </button>
            <button class="portfolio-button" data-filter=".category_4">
              Tab
            </button>
          </div>
          ...
          <div class="row">
			...
			@php $kc++; @endphp
                <div id="knowledge{{$kc}}" class="tab-pane @if($kc==1) active show @endif fade ">
				  ...
				  @if(!empty($knowledge->url_1)) 
                  <div class="service-btn">
                    <a href="{{$knowledge->url_1}}" class="custom-btn">view our caregiver</a>
                    <a href="{{$knowledge->url_2}}" class="custom-btn">view care services</a>
                  </div>
				  @endif
                </div>
			@endforeach
		  ...
		  @foreach($lnews as $news)
            <div class="item wow fadeInUp">
              <div class="news-box">
                ...
                <div class="news-text">
                  <h3>
                    <a href="#">{{substr(strip_tags($news->news_title),0,50) }}</a>
                  </h3>
                  <p>
                    {{substr(strip_tags($news->news_desc),0,250) }}
                  </p>
                  <div class="news-btn">
      ...
      <div class="container">
        ...
        <div class="job-main">
          <ul>
            ...
            <li class="wow fadeInDown" data-wow-delay="0.4s">
              ...
              <div class="detail-blk text-right">
                <a href="{route('job_details',['id'=>$job->id])}}" class="custom-btn">apply</a>
              </div>
            </li>
               @endforeach
              @endif
          ...
          <div class="call-us text-center wow fadeInDown" data-wow-delay="0.9s">
            <a href="#" class="custom-btn">all job listings </a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="sec sec-stay-strong">
      <div class="container">
        <div class="heading-01 wow fadeInDown">
          <h2><span>Simple Process </span>How it helps you stay strong</h2>
        </div>
    ...
    <section class="sec sec-map-contact">
	  ...
	  <div class="col-md-6">
		  ...
		  var locations = [
			  				['City Business Park - Plymouth City Council, United Kingdom',50.381479616943686, -4.161398086064167,'office'],
							['Bristol, United Kingdom',51.45456659896047, -2.5879337029626566,'office'],
			  				['Truro, United Kingdom',50.26340417051112, -5.0515110129515435,'office']];
