            ...
            <div class="col-md-6">
                <div class="widget">
                    <div class="form-elements-sec">
                        ...
                        <form role="form" method="post" action="{{route('admin::menus.store')}}" class="sec" name="add_category_form">
                           {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" id="title" name="title" class="form-control auto_generate_link_from" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="is_collection" class="sr-only">Is Collection Page?</label>
                                <input type="checkbox" value="1" id="is_collection" name="is_collection"  class="form-control" >
                            </div>
                            <div class="form-group">
                                ...
                                <select name="parent_id">
                                    ...
                                    <option  @if($parent_menu->id==$parent_id) selected @endif value="{{$parent_menu->id}}">{{$parent_menu->menu_name}}</option>
                                        @endforeach
                                </select>
                            </div>

                            <button class="btn green btn-default" type="submit" name="add_category_btn">Add Menu Item</button>
                        </form>
                    </div>
                </div>
            </div>    </div>
