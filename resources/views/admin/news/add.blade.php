            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                        ...
                        <form method="post" id="" class="form-horizontal" action="{{route('admin::news.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">

                            {{ csrf_field() }}

                            {{--<div class="form-group">--}}
                            {{--<label class="col-sm-4 control-label">Page<span style="color: red;">*</span></label>--}}
                            {{--<div class="col-sm-8">--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea placeholder="Content" id="content" name="description" class="form-control">{{old('description')}}</textarea>
