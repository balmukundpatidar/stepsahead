        ...
        <div class="panel-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="post" id="" class="form-horizontal" action="{{url('admin/updateprocess')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">
                        <input type="hidden" name="_method" value="POST">
                        <input type="hidden" name="care_id" value="{{$info->id}}">
                        {{ csrf_field() }}
						<div class="form-group">
                            <img src="{{url('/')}}/jobs/images/{{$info->image}}" style="height:200px;width:500px;"/>
                        </div>
						 <div class="form-group">
