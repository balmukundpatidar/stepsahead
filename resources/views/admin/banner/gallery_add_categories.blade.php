        ...
        <div class="panel-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                        <form method="post" id="" class="form-horizontal" action="{{url('admin/insertgallerycategories')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">
