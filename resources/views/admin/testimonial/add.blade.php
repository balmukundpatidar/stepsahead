        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header title">
                    <!-- PAGE TITLE ROW -->
                    <h1>Add <span class="sub-title">Testimonial</span></h1>
                </div>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                        ...
                        <div class="portlet">
                            ...
                            <div id="f-3" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <form method="post" id="" class="form-horizontal" action="{{route('admin::testimonial.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">
