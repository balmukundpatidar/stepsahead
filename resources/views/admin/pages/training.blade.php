    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="{{url('admin/training')}}" title="">Training</a></li>
            </ul>
        </div>
            ...
            <div class="row">
               <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="post" id="" class="form-horizontal" action="{{url('admin/updatetraining')}}" accept-charset="UTF-8" enctype="multipart/form-data">
