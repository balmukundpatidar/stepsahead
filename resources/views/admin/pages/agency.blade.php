    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="{{url('admin/agency')}}" title="">Agency</a></li>
            </ul>
        </div>
            ...
            <div class="row">
               <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="post" id="" class="form-horizontal" action="{{url('admin/updateagency')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label">Fifth Section Heading <span style="color: red;">*</span></label>
                            <div class="">
                                <input type ="text" placeholder="Heading" id="content" name="section_5_heading" class="form-control" value="{{$info->section_5_heading}}">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Fifth Section Content <span style="color: red;">*</span></label>
                            <div class="">
                                <textarea placeholder="Description" id="content" name="section_5_desc" class="form-control">{{$info->section_5_desc}}</textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            @if ($info->section_5_img != '')
                            <img src="{{url('/')}}/jobs/images/{{$info->section_5_img}}" style="height:500;width:500px;"/>
                            @else
                            <img src="{{url('/')}}/jobs/images/default.jpg" style="height:200px;width:500px;"/>
                            @endif
                        </div>
						...
						<div class="form-group">
                            <label class="control-label">Fifth Section Image<span style="color: red;">*</span></label>
                            <div class="">
                                <input type="file" name="section_5_img" class="form-control" value="{{$info->section_5_img}}">
                                <span class="help-block"></span>
                            </div>
                        </div>
