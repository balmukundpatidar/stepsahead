        ...
        <div class="panel-content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="post" id="" class="form-horizontal" action="{{url('admin/insertaddress')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="long" class="form-control" value="" required>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="address_type" class="form-control" value="" required>
                                <span class="help-block"></span>
                            </div>
                        </div>
