    ...
    <div class="main-content">
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="{{route('admin::members.index')}}" title="">Add Team Member</a></li>
            </ul>
        </div>
            ...
            <div class="col-md-6">
                <div class="widget">
                    <div class="form-elements-sec">
                        ...
                        <form role="form" method="post" action="{{route('admin::members.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="sec" name="add_category_form">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Name" id="name" name="name" value="{{old('name')}}" class="form-control auto_generate_link_from" required>
                            </div>
                            <div class="form-group">
                                <label class="sr-only">Position</label>
                                <input type="text" placeholder="Position" id="position" name="position" value="{{old('position')}}" class="form-control auto_generate_link_from" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" placeholder="Image" id="image" name="image" class="form-control auto_generate_link_from" required>
                            </div>
                             <div class="form-group">
                                <label class="sr-only">Facebook Url</label>
                                <input type="text" placeholder="Position" id="position" name="facebook_url" value="{{old('facebook_url')}}" class="form-control auto_generate_link_from" >
                            </div>
                             <div class="form-group">
                                <label class="sr-only">Twitter Url</label>
                                <input type="text" placeholder="Position" id="position" name="twitter_url" value="{{old('twitter_url')}}" class="form-control auto_generate_link_from" >
                            </div>
                             <div class="form-group">
                                <label class="sr-only">Linkedin Url</label>
                                <input type="text" placeholder="Position" id="position" name="linkedin_url" value="{{old('linkedin_url')}}" class="form-control auto_generate_link_from" >
                            </div>
                            ...
                            <button class="btn green btn-default" type="submit" name="add_category_btn">Add Team Member</button>
                        </form>
                    </div>
                </div>
            </div>
