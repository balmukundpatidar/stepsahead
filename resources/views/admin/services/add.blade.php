            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                        ...
                        <form method="post" id="" class="form-horizontal" action="{{route('admin::services.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return redirectMe();">
